...
konduktor:
	g++ -std=c++11 -o driverKon driverKonduktor.cpp konduktorMakhlukHidup.h konduktorMakhlukHidup.cpp Manusia.cpp Gerak.cpp MakhlukHidup.cpp Point.cpp HuntingSkill.cpp
